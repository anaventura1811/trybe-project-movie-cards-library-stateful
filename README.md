...
Projeto desenvolvido como requisito parcial para conclusão do módulo de desenvolvimento Front-end do curso de Desenvolvimento Web da Trybe. Neste projeto, foi desenvolvida uma aplicação **React** composta por um conjunto de componentes e controlada por estados. Consiste em uma biblioteca de cards de filmes e é composta por:
...
O objetivo deste projeto foi aprender a implementar componentes que, em conjunto, resultam na biblioteca de cards de filmes.
